...
class CTM_Sold_Items_Statistics_List_Table extends WP_List_Table {
    ...
    function prepare_items() {
        ...
        $sql = "SELECT t1.id,t1.quotation_id,t1.revised_no,t1.item_id,t1.entry,t1.item_desc,t1.quantity,t1.arrival_date,t1.currency,t1.container_name,t3.con_res_date "
        ...
        if ($wpdb->num_rows > 0) {
            foreach ($rs as $value) {
                ...
                $net_price = $wpdb->get_var("SELECT sum(net_price) from {$wpdb->prefix}ctm_quotations_meta WHERE entry='{$value->entry}'");
...
function admin_ctm_sold_items_statistics_page() {
    global $wpdb;
    ...
    <div class="wrap">
        ...
        <h1 class="wp-heading-inline">Best Seller Statistics</h1>
        <a  href='<?= admin_url("admin.php?page=sold-items") ?>' class="page-title-action">Back</a>
        <br/><br/>

...
function admin_ctm_petty_cash_view_page() {
                            ...
                            <div class="inside">
                                <form id="add-new-item-form"  method="post">
                                    ...
                                    <table class="form-table">
                                        <tr>
                                            <td><label>From Account:<span class="text-red">*</span></label><br/>
                                                <select name="from_account" id="payment_source" required>
                                                    <option value="">Source Account</option>
                                                    <?php
                                                    foreach (PAYMENT_SOURCE as $value) {
                                                        $selected = $value == PAYMENT_SOURCE[1] ? 'selected' : 'disabled';
                                                        ?>
                                            ...
                                            <td><label>To Account:<span class="text-red">*</span></label><br/>
                                        ...
                                        <tr>
                                            ...
                                            <td><label>Exchange Rate:<span class="text-red">*</span></label><br/>
                                                <input type=number name='aed_rate' id="aed_rate" step=1" min="1" max="1" value="1" required>
                                                <input type=number name='euro_rate' id="euro_rate" step="0.00001" value="<?= $euro_rate ?>" required>
                                                <input type=number name='usd_rate' id="usd_rate" step="0.00001" value="<?= $usd_rate ?>" required>
                                            </td>
                                        </tr>
                                        <tr>
        ...
        jQuery(document).ready(() => {
            ...
            jQuery('.currency').click(function () {
                ...
                if (pv_type === 'AED') {
                    ...
                    jQuery('#aed_rate').ttr('required', true);

                    jQuery('#euro_rate').hide();
                    jQuery('#euro_rate').removeAttr('required');

                    jQuery('#usd_rate').hide();
                    jQuery('#usd_rate').removeAttr('required');
                ...
                if (pv_type === 'USD') {
                    ...
                    jQuery('#aed_rate').hide();
                    jQuery('#aed_rate').removeAttr('required');

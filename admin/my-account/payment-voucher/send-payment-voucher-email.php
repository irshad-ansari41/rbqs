...
function make_model_send_payment_voucher_email($payment_voucher) {
    global $current_user;
    $content_id = 'content';
    ...
    $client = get_client($payment_voucher->user_id);
    $subject = strtoupper("ROCHE BOBOIS PAYMENT VOUCHER {$payment_voucher->id} {$payment_voucher->paid_to}");
    $designation = get_user_meta($current_user->ID, 'designation', true);
    $filename = $payment_voucher->pdf_path;

    $content = "<p style='font-size:14px;'>Dear {$payment_voucher->paid_to},<p>"
            . "<p style='font-size:14px;'>Please see attached copy of Payment voucher <b>{$payment_voucher->id}</b>. </p>"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h6 class="modal-title">Send Receipt Email</h6>

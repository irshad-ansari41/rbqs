...
function admin_partial_order_arival_page() {
    ...
    if ($status == 'Completed') {
        ...
        wp_redirect(admin_url("/admin.php?page=confirm-order-arrival&id={$id}"));
        exit();
    }
                                ...
                                if (!empty($quotation_meta)) {
                                    $html = "
                                            ...
                                            #welcome-to-aquila input[type=month], #welcome-to-aquila input[type=number], #welcome-to-aquila select, #welcome-to-aquila textarea { width: 100%; }
                                                ...
                                                .CONFIRMED-status{background:red;color:#000;border:1px solid #000;}
                                                    ...
                                                    <table width='800' style='width:100%'>
                                                        ...
                                                        <tr>
                                                            <td  colspan='2' style='text-align:center'><br/>
                                                                <h6><span style='font-size:22px;text-transform: uppercase;'>Partial Order Arrival Statement - T2</span></h6>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <br/>
                                            ...
                                            . "<td colspan='3'  class='text-center'><b>{$status}</b></td>
                                              ...
                                              <tr class='text-center bg-blue'>
                                                ...
                                                <td rowspan=2 class='text-center'><b>Partial Delivery<br/> Amount Payable</b></td>
                                              </tr>
                                              <tr class='text-center bg-blue'>
                                    ...
                                    foreach ($quotation_meta as $value) {
                                        ...
                                        $po = $wpdb->get_row("SELECT id,order_registry,stk_inv_status FROM {$wpdb->prefix}ctm_quotation_po_meta where item_id='{$value->item_id}' AND quotation_id='{$value->quotation_id}'");
                                        ...
                                        $balance1 = $item_status == 'DELIVERED' || $item_status == 'CONFIRMED' ? $balance : 0;
                                        $balance2 = in_array($item_status, ['ARRIVED', 'TRANSIT']) ? $balance : 0;

                                        $advance_amount_payable += $item_status == 'DELIVERED' || $item_status == 'CONFIRMED' ? $balance1 : 0;
                                        $partial_amount_payable += in_array($item_status, ['ARRIVED', 'TRANSIT']) ? $balance2 : 0;
                                    ...
                                    $html .= "<tr class=''>
                                            ...
                                            . "<td  class='text-center'>" . number_format($advance_amount_payable, 2) . "</td>"
                                            . "<td  class='text-center'><b>" . number_format($partial_amount_payable, 2) . "</b></td>
                                                </tr></table>
                                                <br/>
                                                <table>
                                                    <tr>
                                                        <td>Order is in transit and expected to arrive by " . rb_date($order_arrival->create_date, 'd F Y') . ". Amount payable <b>" . (number_format($partial_amount_payable, 2)) . "</b> AED for partial delivery.</b></td>
                                                    </tr>
                                                </table>
                                                <br/><br/>
                                                <br/><br/>";
                                    ...
                                    $pdf_file = make_pdf_file_name("partial_order_arrival_statement_{$id}.pdf")['path'];
                                } else {
    ...
    if (!empty($html)) {
        ...
        pdf_copy($pdf_file, get_option('partial_order_arrival_dir'));
    }
}

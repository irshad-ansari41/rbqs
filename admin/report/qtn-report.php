...
function admin_ctm_qtn_report_page() {
    global $wpdb;
    ...
    $results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}ctm_quotations WHERE trash=0 AND is_showroom=0 AND $whr_from_date AND $whr_to_date ");
    ?>
    <style>
    ...
    <div class="wrap">
        <h1 class="wp-heading-inline">Quotation Report</h1>
        <br/>
        <form method="get">
                    ...
                    <div id="normal-sortables" class="meta-box-sortables ui-sortable">
                        <div id="page-inner-content" class="postbox">
                            ...
                            $table = "<table width='800'>
                                                ...
                                                <tr>
                                                    <td colspan='2' style='text-align:center'><br/><br/>
                                                        <h6><span style='font-size:22px;'>QUOTATION REPORT</span></h6><br/><br/>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            $table .= "<tr class=bg-blue>
                                      ...
                                      <tr>
                                        ...
                                        <td class='text-center' colspan=4><b>" . rb_date($to_date) . "</b></td>
                                      </tr>
                                      ";


                            $table .= "<tr><td  colspan='8'><br/></td></tr>
                                      <tr class='text-center bg-blue'>
                                        <td class='text-center'><b>Quotation ID</b></td>
                                        <td class='text-center'><b>Revised No</b></td>
                                        <td class='text-center'><b>Client Name</b></td>
                                        <td class='text-center'><b>Quotation Type</b></td>
                                        <td class='text-center'><b>Scope</b></td>
                            ...
                            foreach ($results as $value) {
                                ...
                                $table .= "<tr class='text-center'>
                                        ...
                                        <td class='text-center'>{$value->revised_no}</td>
                                        <td class='text-center'>" . get_client($value->client_id, 'name') . "</td>
                                        <td class='text-center'>$value->type</td>
                                        <td class='text-center'>$value->scope</td>
                                        <td class='text-center'>$value->vat</td>
                                        <td class='text-center'>" . show_qtn_status($value) . "</td>
                                        <td class='text-center'>" . rb_datetime($value->updated_at) . "</td>
                                      </tr>";
                            }

                            $table .= "<tr><td colspan='8'><br/></td></tr></table>";
                            ...
                            echo $html;
                            $pdf_file = make_pdf_file_name("quotation_report_{$from_date}_{$to_date}.pdf")['path'];
                            ?>
                        ...
                        <div class="row btn-bottom">
                            <div class="col-sm-12 text-center">
                                ...
                                ?>
                                <a href = '<?= export_excel_report($pdf_file, 'quotation_report', $table) ?>' class='btn btn-success text-white btn-sm '>Export as Excel</a>
                            </div>
                        </div>
                    </div>	
                </div>

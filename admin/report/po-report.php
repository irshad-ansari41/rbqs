...
function admin_ctm_po_report_page() {
    ...
    $results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}ctm_quotations WHERE trash=0 AND status='PURCHASED' AND $whr_from_date AND $whr_to_date ");
    ?>
    <style>
    ...
    <div class="wrap">
        <h1 class="wp-heading-inline">Purchase Order Report</h1>
        <br/>
        <form method="get">
                ...
                <div id="postbox-container" class="postbox-container">
                    <div id="normal-sortables" class="meta-box-sortables ui-sortable">
                        <div id="page-inner-content" class="postbox">
                            ...
                            $table = "<table width='800'>
                                                ...
                                                <tr>
                                                    <td colspan='2' style='text-align:center'><br/><br/>
                                                        <h6><span style='font-size:22px;'>PURCHASE ORDER REPORT</span></h6><br/><br/>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            $table .= "<tr><td  colspan='7'><br/></td></tr>
                            ...
                            foreach ($results as $value) {
                                ...
                                $table .= "<tr class='text-center'>
                                        ...
                                        <td class='text-center'>" . show_purchase_order_status($value->status) . "</td>
                                        <td class='text-center'>" . rb_datetime($value->updated_at) . "</td>
                                      </tr>";
                            }

                            $table .= "<tr><td colspan='7'><br/></td></tr></table>";
                            ...
                            echo $html;
                            $pdf_file = make_pdf_file_name("purchase_order_report_{$from_date}_{$to_date}.pdf")['path'];
                            ?>
                        ...
                        <div class="row btn-bottom">
                            <div class="col-sm-12 text-center">
                                ...
                                ?>
                                <a href = '<?= export_excel_report($pdf_file, 'purchase_order_report', $table) ?>' class='btn btn-success text-white btn-sm '>Export as Excel</a>
                            </div>
                        </div>
                    </div>	
                </div>
